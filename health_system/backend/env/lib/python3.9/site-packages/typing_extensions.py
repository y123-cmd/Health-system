...
if hasattr(typing, "ReadOnly"):  # 3.13+
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False):
        ...
        if sys.version_info < (3, 9):
            ...
            hint = {
                k: (t if get_origin(t) != Union else Union[t.__args__])
...
if hasattr(typing, "evaluate_forward_ref"):
    ...
    def _lax_type_check(
        ...
        if hasattr(typing, "_type_convert"):
            if sys.version_info >= (3, 10, 3) or (3, 9, 10) < sys.version_info[:3] < (
                3,
                10,
            ):
        ...
        if allow_special_forms and type_ in (ClassVar, Final):
            return type_
        if isinstance(type_, (_SpecialForm, typing._SpecialForm)) or type_ in (
            Generic,
            Protocol,
        ):
